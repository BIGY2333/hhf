        ...
        for j in range(epoch):
            ...
            for i in range(Iteration):
                ...
                if i % 100 == 0:
                    ...
                    # print("acc_rate32 is : ", acc_rate32)
                    # print("acc_rate16 is : ", acc_rate16)
                    mat_cross32, label_cross32 = sess.run([Mat_batch_cross, Label32_batch_cross])
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        converted_graph_def = graph_util.convert_variables_to_constants(sess, gd,['X',
                                                                                     'is_train', 'kp', 'y', 'acc',
                                                                                     'output'])
